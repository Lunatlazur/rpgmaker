/**
 * RPG Maker MV - Windows Module Types
 * グローバル型定義をRPGMakerMV名前空間としてre-exportします
 */

/// <reference path="../typings/rpg_windows.d.ts" />
...
export namespace RPGMakerMV {
  ...
  export type Window_Command = globalThis.Window_Command;
  export type Window_HorzCommand = globalThis.Window_HorzCommand;
  export type Window_Help = globalThis.Window_Help;
  export type Window_Gold = globalThis.Window_Gold;
  export type Window_MenuCommand = globalThis.Window_MenuCommand;
  export type Window_MenuStatus = globalThis.Window_MenuStatus;
  export type Window_MenuActor = globalThis.Window_MenuActor;
  export type Window_ItemCategory = globalThis.Window_ItemCategory;
  ...
  export type Window_EquipCommand = globalThis.Window_EquipCommand;
  ...
  export type Window_Options = globalThis.Window_Options;
  export type Window_SavefileList = globalThis.Window_SavefileList;
  export type Window_ShopCommand = globalThis.Window_ShopCommand;
  ...
  export type Window_ChoiceList = globalThis.Window_ChoiceList;
  ...
  export type Window_PartyCommand = globalThis.Window_PartyCommand;
  ...
  export type Window_TitleCommand = globalThis.Window_TitleCommand;
  export type Window_GameEnd = globalThis.Window_GameEnd;
  ...
  export type TextState = globalThis.RPGMakerMV.TextState;
  export type DataCommand = globalThis.RPGMakerMV.DataCommand;
  export type NameInputLatin1 = globalThis.RPGMakerMV.NameInputLatin1;
  export type NameInputLatin2 = globalThis.RPGMakerMV.NameInputLatin2;
  export type NameInputCyrillic = globalThis.RPGMakerMV.NameInputCyrillic;
}